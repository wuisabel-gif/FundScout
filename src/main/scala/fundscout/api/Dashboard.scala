...
.gh-link { display: grid; place-items: center; width: 34px; height: 34px; border-radius: 8px; color: var(--muted); transition: color 0.16s var(--ease), background 0.16s var(--ease); }
.gh-link:hover { color: var(--ink); background: var(--surface); }
.gh-link svg { width: 21px; height: 21px; fill: currentColor; display: block; }
...
<header class="topbar">
  ...
  <div class="topbar-right">
    ...
    <a class="gh-link" href="https://github.com/wuisabel-gif/FundScout" target="_blank" rel="noopener noreferrer" aria-label="View source on GitHub" title="View on GitHub">
